...
void loop() {
  ...
  // Update Firebase with TDS value every 5 seconds
  if (millis() - sendDataPrevMillis >= sendInterval) {
    sendDataPrevMillis = millis();

    String path = "/phase1";  // Ensure this matches the structure in your Firebase database
